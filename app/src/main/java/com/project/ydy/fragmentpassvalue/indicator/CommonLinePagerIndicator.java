...
public class CommonLinePagerIndicator extends View implements IPagerIndicator {
    ...
    /**
     * 相对于底部的偏移量(如果想让直线位于title上方，设置它即可)
     */
    ...
    private void init(Context context) {
        ...
        mLineHeight = AppUtil.dip2px(context, 3);
        mLineWidth = AppUtil.dip2px(context, 10);
    }
